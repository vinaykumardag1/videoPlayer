  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={`no-pull-refresh fixed z-50 bg-black text-white overflow-hidden ${!isMini ? "flex flex-col inset-0 safe-top safe-bottom" : ""}`}
      >
        {/* Close (mini only) */}
        {isMini && (
          <motion.button
        ...
        {/* Video */}
        <div
          className={`w-full h-full ${isMini ? "aspect-video" : "flex-1 min-h-0"}`}
        >
          <iframe
